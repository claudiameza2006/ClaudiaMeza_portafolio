...
const Index = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      tools: ["TypeScript", "Gherkin", "Playwright", "Node.js"], // Asumiendo Playwright y Node.js para la automatización web con TypeScript
      demonstrates: ["Test automation", "performance testing", "web application testing", "DevOps"],
    },
    {
